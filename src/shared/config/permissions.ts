...
export const permissionTree: readonly PermissionNode[] = [
  ...
  },
  {
    ...
    label: 'Users',
    children: [
      { key: 'users.employees', label: 'Employees', actions: crud },
      { key: 'users.autoparks', label: 'Autoparks', actions: crudExport },
      { key: 'users.drivers', label: 'Drivers', actions: crud },
      { key: 'users.roles', label: 'Access & roles', actions: crud },
      { key: 'users.salary', label: 'See salary', actions: readOnly },
    ],
  },
  {
    key: 'marketing',
    label: 'Marketing',
    children: [{ key: 'marketing.promotions', label: 'Promotions', actions: crud }],
  },
  {
    key: 'analytics',
    label: 'Analytics',
  ...
  },
  {
    ...
    children: [
      ...
      { key: 'settings.registers', label: 'Cash registers', actions: crud },
